...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { phone: @office.phone, physician_id: @office.physician_id, street_address: @office.street_address, zip_code: @office.zip_code } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { phone: @office.phone, physician_id: @office.physician_id, street_address: @office.street_address, zip_code: @office.zip_code } }
